...
public interface IRepository<T> where T : class
{
    ...
    Task<IReadOnlyList<T>> ListAllReadOnlyAsync();
    Task<IReadOnlyList<T>> ListAsync(System.Linq.Expressions.Expression<Func<T, bool>> predicate);
    Task<IReadOnlyList<T>> ListReadOnlyAsync(System.Linq.Expressions.Expression<Func<T, bool>> predicate);
    Task<IReadOnlyList<T>> ListAsync(System.Linq.Expressions.Expression<Func<T, bool>> predicate, int skip, int take);
    Task<IReadOnlyList<T>> ListReadOnlyAsync(System.Linq.Expressions.Expression<Func<T, bool>> predicate, int skip, int take);
